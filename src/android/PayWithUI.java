        ...
        activity.runOnUiThread(new Runnable() {
            public void run() {
                try {
                    ...
                    Pay pay = new Pay(activity, customerId, description, amount, currency, transactionRef, options, new SerializablePaymentCallback<PurchaseResponse>(new IswCallback<PurchaseResponse>() {
                        @Override
